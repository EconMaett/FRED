...
df |> 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(12.5e3, 22.5e3), labels = label_number(suffix = "K", scale = 1e-3)) +
  scale_color_manual(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Real-Personal-Income.png", width = 8, height = 4)
graphics.off()
...
pmsave |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(0, 8e3), labels = label_number(suffix = "K", scale = 1e-3)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Personal-Savings.png", height = 4, width = 8)
graphics.off()
...
df |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(350e3, 600e3), labels = label_number(suffix = "K", scale = 1e-3)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Real-Retail-Sales.png", height = 4, width = 8)
graphics.off()
...
altsales |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(0, 20), labels = label_number(suffix = "M")) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Light-Weight-Vehicle-Sales.png", height = 4, width = 8)
graphics.off()
...
indpro |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(80, 110), breaks = seq(80, 110, 5)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Industrial-Production.png", height = 4, width = 8)
graphics.off()
...
tcu |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(60, 85), breaks = seq(60, 85, 5)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Capacity-Utilization.png", height = 4, width = 8)
graphics.off()
...
df |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(50e3, 75e3), labels = label_number(suffix = "K", scale = 1e-3)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Manufacturers-Nondefense-Capital-Goods-Ship.png", height = 4, width = 8)
graphics.off()
...
df |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(125e3, 250e3), labels = label_number(suffix = "K", scale = 1e-3)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Manufacturers-New-Durable-Goods-Orders.png", height = 4, width = 8)
graphics.off()
...
df |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(750, 2000), breaks = seq(750, 2000, 250)) +
  scale_color_manual(
    values = c("#374e8e", "#ac004f"), 
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_New-Private-Housing-Construction.png", width = 8, height = 4)
graphics.off()
...
df |> 
  ...
  geom_rect(data = usrecdp, aes(xmin = recession_start, xmax = recession_end, ymin = -Inf, ymax = +Inf), fill = "darkgrey", alpha = 0.3) +
  scale_x_date(expand = c(0, 0), limits = c(date(start_date), NA), date_breaks = "1 year", date_labels = "%Y") +  
  scale_y_continuous(expand = c(0, 0), limits = c(-10, 30), breaks = seq(-10, 30, 10)) +
  scale_color_manual(
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Housing-Prices.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Macro-Snapshot/Other-Real-Indicators/Fig_Weekly-Economic-Index.png", width = 8, height = 4)
graphics.off()
