...
write_csv(usrecdm, file = "Recession_Dates/NBER/US_NBER_Midpoint_Daily_Recession_Dates.csv")
...
write_csv(usrecdm, file = "Recession_Dates/NBER/US_NBER_Trough_Daily_Recession_Dates.csv")
...
write_csv(usrecdp, file = "Recession_Dates/NBER/US_NBER_Peak_Daily_Recession_Dates.csv")
...
write_csv(usrec, file = "Recession_Dates/NBER/US_NBER_Trough_Monthly_Recession_Dates.csv")
...
write_csv(us_nber_rec, file = "Recession_Dates/NBER/US_NBER_Trough_Monthly_Recession_Dates.csv")
