...
usrecdp <- read_csv(file = "Recession_Dates/OECD/US_OECD_Midpoint_Daily_Recession_Dates.csv")
...
download.file(url = tracker_url1, destfile = "Nowcasts/OECDWeeklyTracker/Weekly_Tracker_Excel.xlsx", method = "curl")
download.file(url = tracker_url2, destfile = "Nowcasts/OECDWeeklyTracker/weekly_tracker_level.xlsx", method = "curl")

# Every country is in another sheet of the Excel file
df <- readxl::read_excel(path = "Nowcasts/OECDWeeklyTracker/Weekly_Tracker_Excel.xlsx", 
                         sheet = "United States")
df
names(df)
...
ggsave(filename = "Nowcasts/OECDWeeklyTracker/OECDWeeklyTrackeryoy.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/OECDWeeklyTracker/OECDWeeklyTrackeryo2y.png", width = 8, height = 4)
graphics.off()
