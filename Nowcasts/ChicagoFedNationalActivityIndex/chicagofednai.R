...
ggsave(filename = "Nowcasts/ChicagoFedNationalActivityIndex/ChicagoFedNAIvsGDP.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/ChicagoFedNationalActivityIndex/ChicagoFedNAISubIndices.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/ChicagoFedNationalActivityIndex/ChicagoFedNAI3MAvsGDP.png", width = 8, height = 4)
graphics.off()
