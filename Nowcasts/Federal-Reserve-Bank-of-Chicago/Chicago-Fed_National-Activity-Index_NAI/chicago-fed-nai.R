...
ggsave(filename = "Nowcasts/Chicago-Fed_National-Activity-Index_NAI/Fig_Chicago-Fed-NAI-vs-GDP.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/Chicago-Fed_National-Activity-Index_NAI/Fig_Chicago-Fed-NAI-Sub-Indices.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/Chicago-Fed_National-Activity-Index_NAI/Fig_Chicago-Fed-NAI-3MA-vs-GDP.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/Chicago-Fed_National-Activity-Index_NAI/Fig_Chicago-Fed-NAI-Diffusion-Index.png", width = 8, height = 4)
graphics.off()
