...
ggsave(filename = "Nowcasts/BraveButtersKelleyIndexes/BBKGDP.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/BraveButtersKelleyIndexes/BBKICoiLead.png", width = 8, height = 4)
graphics.off()
