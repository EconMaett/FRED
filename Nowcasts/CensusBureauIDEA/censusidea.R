...
index |> 
  ...
  scale_y_continuous(limits = c(-12, 4), breaks = seq(-12, 4, 2)) +
  theme_bw() +
  labs(
...
ggsave(filename = "Nowcasts/CensusBureauIDEA/CensusBureauIDEA.png", width = 8, height = 4)
graphics.off()
...
ggsave(filename = "Nowcasts/CensusBureauIDEA/CensusVSGDP.png", width = 8, height = 4)
graphics.off()
